...
const emailSuccessIcon = document.getElementById('emailtrue');
const emailFailIcon = document.getElementById('emailfalse');
const spinnerIcon = document.getElementById('iconContainer');
